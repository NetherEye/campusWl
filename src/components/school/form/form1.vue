    ...
    <div class="block">
        ...
        <div class="tableData">
            <el-table ref="singleTable" :data="tableData" header-cell-class-name="tableTou" cell-class-name="tableRow" highlight-current-row style="width: 100%" :summary-method="getSummaries" show-summary>
                ...
                <el-table-column label="充值钱包" align="center">
                    <template slot-scope="scope">
                ...
                <el-table-column property="deviceNumber" label="设备编号" align="center">
                </el-table-column>
                <el-table-column property="deviceSerialNumber" label="设备类型" align="center">
                </el-table-column>
                <el-table-column prop="transactDate" label="充值时间" align="center">
                </el-table-column>
            </el-table>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            fetch.get(Allapi.recharge, par, res => {
                if (res.code == 200) {
        ...
        exports(){
            fetch.export(Allapi.exportRecharge, {...this.filter}, res => {})
        }
