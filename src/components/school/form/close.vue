    ...
    <div class="block">
        ...
        <div class="tableData">
            <el-table ref="singleTable" :data="tableData" highlight-current-row style="width: 100%" :summary-method="getSummaries" show-summary>
                ...
                <el-table-column property="cost" label="应退工本费" align="center">
                </el-table-column>
                <el-table-column property="cashPledge" label="应退押金" align="center">
                </el-table-column>
                <el-table-column property="backPrice" label="应退余额" align="center">
                </el-table-column>
                <el-table-column label="注销时间" prop="createTime" align="center">
                </el-table-column>
            </el-table>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            fetch.get(Allapi.cardReport, par, res => {
                if (res.code == 200) {
                    ...
                    this.backPriceSum = res.data.backPriceSum
        ...
        getSummaries(param) {
            ...
            columns.forEach((column, index) => {
                if (index === 0) {
                    ...
                    sums[index] = this.backPriceSum + '元';
                    return;
                } else {
                    sums[index] = '';
                }
        ...
        exports() {
            fetch.export(Allapi.exportM1, {...this.filter,pageNumber: this.pageNumber,pageSize: this.pageSize,reportType: 2}, res => {})
        }
