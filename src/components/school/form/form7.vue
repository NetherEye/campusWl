    ...
    <div class="block">
            ...
            <div class="fitler-wrap">
                <el-form :inline="true" :model="filter" class="demo-form-inline">
                    ...
                    <el-form-item label="商户编号">
                        <el-input v-model="filter.merchantId" clearable placeholder="请输入内容"></el-input>
                    </el-form-item>
                    <el-form-item label="商户名称">
                        <el-input v-model="filter.merchantName" clearable placeholder="请输入姓名"></el-input>
                    </el-form-item>
        ...
        <div class="tableData">
            <el-table ref="singleTable" :data="tableData" highlight-current-row style="width: 100%" :summary-method="getSummaries" show-summary>
                ...
                <el-table-column property="use_count" label="交易流水号" align="center">
                </el-table-column>
                <el-table-column property="merchantId" label="商户编号" align="center">
                </el-table-column>
                ...
                <el-table-column property="person_name" label="姓名" align="center"></el-table-column>
                <el-table-column property="balance" label="卡余额" align="center"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            fetch.get(Allapi.error, par, res => {
                if (res.code == 200) {
        ...
        exports(){
            fetch.export(Allapi.errorExcel, {...this.filter}, res => {})
        }
