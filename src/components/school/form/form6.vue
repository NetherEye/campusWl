    ...
    <div class="block">
        <div class="header">
            <div class="fitler-wrap">
                <el-form :inline="true" :model="filter" class="demo-form-inline">
                    <el-form-item label="商户编号" prop="cardPrice">
        ...
        <div class="tableData">
            <el-table ref="singleTable" :data="tableData" highlight-current-row style="width: 100%" :summary-method="getSummaries" show-summary>
                ...
                <el-table-column property="person_name" label="人员姓名" align="center"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        getData() {
            ...
            fetch.get(Allapi.merchant, par, res => {
                if (res.code == 200) {
        ...
        exports(){
            fetch.export(Allapi.merchantExcel, {...this.filter}, res => {})
        }
