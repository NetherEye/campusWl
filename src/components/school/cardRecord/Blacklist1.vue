      ...
      <div class="block" v-if="condition">
        <div class="header">
          <div class="fitler-wrap">
            <el-form :inline="true" :model="tfilter" class="demo-form-inline">
              ...
              <el-form-item>
                <el-button type="success" @click="exportAlready">导出</el-button>
              </el-form-item>
            </el-form>
          </div>
        </div>
        <div class="tableData">
          ...
          <el-table-column label="序号" type="index" :index="indexMethod" width="100px" align="center"></el-table-column>
            ...
            <el-table-column prop="personType" label="人员类别" align="center" show-overflow-tooltip>
            ...
            <el-table-column property="receiveMoney" label="已领取（元）" align="center">
            </el-table-column>
            <el-table-column property="deviceNumber" label="设备机号" align="center">
            </el-table-column>
          </el-table>
  ...
  export default {
    ...
    methods: {
      ...
      getData() {
        ...
        fetch.get(schoolApi.already, par, res => {
          if (res.code == 200) {
      ...
      exportAlready(){
        ...
        fetch.export(schoolApi.exportAlready, par, res => {})
      },
      reset() {
